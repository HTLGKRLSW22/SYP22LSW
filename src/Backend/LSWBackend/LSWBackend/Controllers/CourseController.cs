...
namespace LSWBackend.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        public ActionResult DeleteCourse(int courseId)
        {
            ...
            if (_service.DeleteOffer(out errorMsg, courseId)) return BadRequest(errorMsg);
            return Ok();
        }
        ...
        public ActionResult<OfferDto> CreateCourse(int teacherId, [FromBody] OfferDto offerDto)
        {
            ...
            if (!_service.CreateOffer(out errorMsg, teacherId, new Offer().CopyPropertiesFrom(offerDto))) return BadRequest(errorMsg);
            return Ok(offerDto);
        }
        ...
        public ActionResult<OfferDto> EditCourse(int id, [FromBody] OfferDto offerDto)
        {
            ...
            _service.EditOffer(id, new Offer().CopyPropertiesFrom(offerDto));
            return Ok(offerDto);
        }
